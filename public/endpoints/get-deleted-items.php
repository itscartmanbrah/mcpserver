...
/**
 * Auto-generated endpoint tester for: GetDeletedItems
 *
...
try {
  ...
  0 => 'searchby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetDeletedItems($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetDeletedItemsResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetDeletedItems SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetDeletedItems FAILED (SoapFault)\n";
