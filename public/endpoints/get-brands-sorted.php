...
/**
 * Auto-generated endpoint tester for: GetBrandsSorted
 *
...
try {
  ...
  1 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetBrandsSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetBrandsSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetBrandsSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetBrandsSorted FAILED (SoapFault)\n";
