...
/**
 * Auto-generated endpoint tester for: GetAllCategoriesSorted
 *
...
try {
  ...
  0 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetAllCategoriesSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllCategoriesSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllCategoriesSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllCategoriesSorted FAILED (SoapFault)\n";
