...
/**
 * Auto-generated endpoint tester for: GetItemImageURL
 *
...
try {
  ...
  2 => 'imageindex=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetItemImageURL($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetItemImageURLResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetItemImageURL SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetItemImageURL FAILED (SoapFault)\n";
