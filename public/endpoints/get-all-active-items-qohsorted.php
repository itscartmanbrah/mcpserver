...
/**
 * Auto-generated endpoint tester for: GetAllActiveItemsQOHSorted
 *
...
try {
  ...
  0 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetAllActiveItemsQOHSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllActiveItemsQOHSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllActiveItemsQOHSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllActiveItemsQOHSorted FAILED (SoapFault)\n";
