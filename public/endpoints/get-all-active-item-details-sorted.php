...
/**
 * Auto-generated endpoint tester for: GetAllActiveItemDetailsSorted
 *
...
try {
  ...
  0 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetAllActiveItemDetailsSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllActiveItemDetailsSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllActiveItemDetailsSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllActiveItemDetailsSorted FAILED (SoapFault)\n";
