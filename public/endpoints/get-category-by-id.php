...
/**
 * Auto-generated endpoint tester for: GetCategoryByID
 *
...
try {
  ...
  0 => 'categoryid=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetCategoryByID($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetCategoryByIDResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetCategoryByID SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetCategoryByID FAILED (SoapFault)\n";
