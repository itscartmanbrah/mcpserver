...
/**
 * Auto-generated endpoint tester for: GetCategoriesSorted
 *
...
try {
  ...
  1 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetCategoriesSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetCategoriesSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetCategoriesSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetCategoriesSorted FAILED (SoapFault)\n";
