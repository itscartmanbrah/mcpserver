...
/**
 * Auto-generated endpoint tester for: GetAllBrandsSorted
 *
...
try {
  ...
  0 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetAllBrandsSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllBrandsSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllBrandsSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllBrandsSorted FAILED (SoapFault)\n";
