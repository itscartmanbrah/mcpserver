...
/**
 * Auto-generated endpoint tester for: GetVendors
 *
...
try {
  ...
  0 => 'searchby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetVendors($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetVendorsResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetVendors SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetVendors FAILED (SoapFault)\n";
