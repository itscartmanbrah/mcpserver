...
/**
 * Auto-generated endpoint tester for: GetActiveItemDetails
 *
...
try {
  ...
  0 => 'searchby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetActiveItemDetails($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetActiveItemDetailsResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetActiveItemDetails SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetActiveItemDetails FAILED (SoapFault)\n";
