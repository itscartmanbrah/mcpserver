...
/**
 * Auto-generated endpoint tester for: GetDeletedItemByStockNum
 *
...
try {
  ...
  1 => 'stocknum=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetDeletedItemByStockNum($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetDeletedItemByStockNumResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetDeletedItemByStockNum SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetDeletedItemByStockNum FAILED (SoapFault)\n";
