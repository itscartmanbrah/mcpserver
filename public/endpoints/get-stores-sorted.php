...
/**
 * Auto-generated endpoint tester for: GetStoresSorted
 *
...
try {
  ...
  1 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetStoresSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetStoresSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetStoresSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetStoresSorted FAILED (SoapFault)\n";
