...
/**
 * Auto-generated endpoint tester for: GetActiveItems
 *
...
try {
  ...
  0 => 'searchby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetActiveItems($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetActiveItemsResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetActiveItems SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetActiveItems FAILED (SoapFault)\n";
