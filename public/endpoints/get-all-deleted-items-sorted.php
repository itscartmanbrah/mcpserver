...
/**
 * Auto-generated endpoint tester for: GetAllDeletedItemsSorted
 *
...
try {
  ...
  0 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetAllDeletedItemsSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllDeletedItemsSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllDeletedItemsSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllDeletedItemsSorted FAILED (SoapFault)\n";
