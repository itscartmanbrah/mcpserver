...
/**
 * Auto-generated endpoint tester for: GetCustomersSorted
 *
...
try {
  ...
  1 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetCustomersSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetCustomersSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetCustomersSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetCustomersSorted FAILED (SoapFault)\n";
