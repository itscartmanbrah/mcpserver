...
/**
 * Auto-generated endpoint tester for: GetActiveItemDetailsByStockNum
 *
...
try {
  ...
  1 => 'stocknum=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetActiveItemDetailsByStockNum($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetActiveItemDetailsByStockNumResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetActiveItemDetailsByStockNum SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetActiveItemDetailsByStockNum FAILED (SoapFault)\n";
