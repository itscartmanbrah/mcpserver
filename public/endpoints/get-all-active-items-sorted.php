...
/**
 * Auto-generated endpoint tester for: GetAllActiveItemsSorted
 *
...
try {
  ...
  0 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetAllActiveItemsSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllActiveItemsSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllActiveItemsSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllActiveItemsSorted FAILED (SoapFault)\n";
