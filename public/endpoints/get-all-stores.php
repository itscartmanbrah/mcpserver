...
/**
 * Auto-generated endpoint tester for: GetAllStores
 *
...
try {
    ...
    // Call SOAP method
    $response = $soapClient->GetAllStores($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllStoresResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllStores SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllStores FAILED (SoapFault)\n";
