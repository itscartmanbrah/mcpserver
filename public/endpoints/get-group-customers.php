...
/**
 * Auto-generated endpoint tester for: GetGroupCustomers
 *
...
try {
    ...
    // Call SOAP method
    $response = $soapClient->GetGroupCustomers($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetGroupCustomersResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetGroupCustomers SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetGroupCustomers FAILED (SoapFault)\n";
