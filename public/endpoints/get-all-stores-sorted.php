...
/**
 * Auto-generated endpoint tester for: GetAllStoresSorted
 *
...
try {
  ...
  0 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetAllStoresSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllStoresSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllStoresSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllStoresSorted FAILED (SoapFault)\n";
