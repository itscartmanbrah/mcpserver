...
/**
 * Auto-generated endpoint tester for: GetActiveItemsQOHSorted
 *
...
try {
  ...
  1 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetActiveItemsQOHSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetActiveItemsQOHSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetActiveItemsQOHSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetActiveItemsQOHSorted FAILED (SoapFault)\n";
