...
/**
 * Auto-generated endpoint tester for: GetBrands
 *
...
try {
  ...
  0 => 'searchby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetBrands($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetBrandsResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetBrands SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetBrands FAILED (SoapFault)\n";
