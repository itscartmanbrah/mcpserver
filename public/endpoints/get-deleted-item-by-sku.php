...
/**
 * Auto-generated endpoint tester for: GetDeletedItemBySKU
 *
...
try {
  ...
  0 => 'sku=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetDeletedItemBySKU($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetDeletedItemBySKUResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetDeletedItemBySKU SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetDeletedItemBySKU FAILED (SoapFault)\n";
