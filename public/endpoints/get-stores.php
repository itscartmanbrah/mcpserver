...
/**
 * Auto-generated endpoint tester for: GetStores
 *
...
try {
  ...
  0 => 'searchby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetStores($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetStoresResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetStores SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetStores FAILED (SoapFault)\n";
