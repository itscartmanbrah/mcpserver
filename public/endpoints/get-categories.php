...
/**
 * Auto-generated endpoint tester for: GetCategories
 *
...
try {
  ...
  0 => 'searchby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetCategories($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetCategoriesResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetCategories SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetCategories FAILED (SoapFault)\n";
