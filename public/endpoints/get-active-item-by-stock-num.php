...
/**
 * Auto-generated endpoint tester for: GetActiveItemByStockNum
 *
...
try {
  ...
  1 => 'stocknum=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetActiveItemByStockNum($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetActiveItemByStockNumResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetActiveItemByStockNum SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetActiveItemByStockNum FAILED (SoapFault)\n";
