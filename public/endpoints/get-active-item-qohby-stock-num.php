...
/**
 * Auto-generated endpoint tester for: GetActiveItemQOHByStockNum
 *
...
try {
  ...
  1 => 'stocknum=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetActiveItemQOHByStockNum($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetActiveItemQOHByStockNumResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetActiveItemQOHByStockNum SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetActiveItemQOHByStockNum FAILED (SoapFault)\n";
