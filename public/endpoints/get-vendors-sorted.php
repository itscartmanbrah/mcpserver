...
/**
 * Auto-generated endpoint tester for: GetVendorsSorted
 *
...
try {
  ...
  1 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetVendorsSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetVendorsSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetVendorsSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetVendorsSorted FAILED (SoapFault)\n";
