...
/**
 * Auto-generated endpoint tester for: GetAllDeletedItems
 *
...
try {
    ...
    // Call SOAP method
    $response = $soapClient->GetAllDeletedItems($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetAllDeletedItemsResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetAllDeletedItems SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetAllDeletedItems FAILED (SoapFault)\n";
