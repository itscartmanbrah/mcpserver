...
/**
 * Auto-generated endpoint tester for: GetCustomers
 *
...
try {
  ...
  0 => 'searchby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetCustomers($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetCustomersResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetCustomers SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetCustomers FAILED (SoapFault)\n";
