...
/**
 * Auto-generated endpoint tester for: GetActiveItemDetailsSorted
 *
...
try {
  ...
  1 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetActiveItemDetailsSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetActiveItemDetailsSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetActiveItemDetailsSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetActiveItemDetailsSorted FAILED (SoapFault)\n";
