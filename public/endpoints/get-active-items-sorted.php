...
/**
 * Auto-generated endpoint tester for: GetActiveItemsSorted
 *
...
try {
  ...
  1 => 'sortby=...',
    ...
    // Call SOAP method
    $response = $soapClient->GetActiveItemsSorted($payload);

    // Typical SOAP result property naming: <MethodName>Result
    $resultProp = 'GetActiveItemsSortedResult';
    $result = $response->{$resultProp} ?? $response;

    echo "GetActiveItemsSorted SUCCESS\n\n";
    print_r($result);

} catch (SoapFault $fault) {
    http_response_code(502);

    echo "GetActiveItemsSorted FAILED (SoapFault)\n";
